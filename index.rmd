...
Use first model as a checkpoint and continue training for another 39 epochs.
...
for(f in list.files("./R", full.names=TRUE)) source(f); rm(f)

X=as.matrix(dfPoisson[, 1:3])
Y=as.matrix(dfPoisson[, 4])
family="gamma"
learning_rate=0.005
num_epochs=39
